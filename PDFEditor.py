...
class SelectablePDFViewer:
    ...
    def apply_page_crop_resize_dialog(self):
        ...
        try:
            ...
            self.macro_manager.record_action('apply_page_crop_resize', **result)
...
# _save_state, _update_status i _reconfigure_grid.
    ...
    def insert_page_numbers(self):
        ...
        try:
            ...
            self.macro_manager.record_action('insert_page_numbers', 
    ...
    def remove_page_numbers(self):
        ...
        try:
          ...
          #      self._save_state_to_undo()
                ...
                self.macro_manager.record_action('remove_page_numbers', top_mm=top_mm, bottom_mm=bottom_mm)
            else:
    ...
    def shift_page_content(self):
        ...
        try:
            ...
            self.macro_manager.record_action('shift_page_content',
                x_mm=result['x_mm'],
                y_mm=result['y_mm'],
                x_dir=result['x_dir'],
                y_dir=result['y_dir'])
    ...
    def _select_odd_pages(self):
        ...
        # Nagraj akcję
        self.macro_manager.record_action('select_odd')
    ...
    def _select_even_pages(self):
        ...
        # Nagraj akcję
        self.macro_manager.record_action('select_even')
    ...
    def _select_portrait_pages(self):
        ...
        for i in range(len(self.pdf_document)):
            ...
            if page.rect.height > page.rect.width:
                indices.append(i)
        self._apply_selection_by_indices(indices)
        self.macro_manager.record_action('select_portrait')
    ...
    def _select_landscape_pages(self):
        ...
        for i in range(len(self.pdf_document)):
            ...
            if page.rect.width >= page.rect.height:
                indices.append(i)
        self._apply_selection_by_indices(indices)
        self.macro_manager.record_action('select_landscape')
    ...
    def __init__(self, master):
        ...
        self.macro_manager = MacroManager(self, self.prefs_manager, master)
        # Keep backward compatibility for dialog reference
    ...
    def _select_all(self):
        if self.pdf_document:
            ...
            self.macro_manager.record_action('select_all')
    ...
    def _handle_lpm_click(self, page_index, event):
        ...
        if getattr(self, "macro_recording", False):
            ...
            self.macro_manager.record_action('select_custom', indices=indices, source_page_count=page_count)
    ...
    def rotate_selected_page(self, angle):
        ...
        # Nagraj akcję
        if angle == -90:
            self.macro_manager.record_action('rotate_left')
        elif angle == 90:
            self.macro_manager.record_action('rotate_right')
    ...
    def record_macro(self):
        ...
        self.macro_manager.open_recording_dialog()
    
    def show_macros_list(self):
        """Wyświetla listę makr użytkownika"""
        self.macro_manager.show_macros_list()
        # Keep backward compatibility for dialog reference
        self.macros_list_dialog = self.macro_manager.macros_list_dialog
    
    def run_macro(self, macro_name):
        """Uruchamia makro o podanej nazwie"""
        self.macro_manager.run_macro(macro_name)
